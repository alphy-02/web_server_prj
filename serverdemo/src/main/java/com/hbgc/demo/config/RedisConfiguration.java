...
public class RedisConfiguration extends CachingConfigurerSupport {
    ...
    @Bean
    //redisTemplate ioc容器管理，让redis保存json对象。
    ...
    /*
    @Bean("menuListTemplate")

    //@Bean
    public RedisTemplate<Object, Object> redisMenuViewTemplate(RedisConnectionFactory redisConnectionFactory) {
        //设置序列化
        RedisTemplate<Object, Object> redisTemplate = new RedisTemplate<Object, Object>();
        //GenericJackson2JsonRedisSerializer jackson2JsonRedisSerializer = new GenericJackson2JsonRedisSerializer();
        //Jackson2JsonRedisSerializer<Object> jackson2JsonRedisSerializer = new Jackson2JsonRedisSerializer<Object>(Object.class);
        //Jackson2JsonRedisSerializer<Menu> jackson2JsonRedisSerializer = new Jackson2JsonRedisSerializer<Menu>(Menu.class);
        Jackson2JsonRedisSerializer<MenuView> jackson2JsonRedisSerializer = new Jackson2JsonRedisSerializer<MenuView>(MenuView.class);
