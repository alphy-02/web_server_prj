...
import com.hbgc.demo.util.MyUtils;
...
//    //生成短地址
//    @GetMapping("shorturl")
//    public Map<String,Object> generateShortUrl(String token, String url, HttpServletRequest request, HttpServletResponse response){
...
//            }
//
//            return Json.success(shortUrl,"生成地址成功！");
//        }catch(Exception ex){
//            ex.printStackTrace();
//            return Json.fail("生成地址失败！");
//        }
//    }
