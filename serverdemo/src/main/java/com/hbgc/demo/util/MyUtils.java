...
public class MyUtils {
    ...
    static final String accessKeyId = "LTAI4FcbzxADET62e5DgevXx";
    static final String accessKeySecret = "wiAoBuiNjH7uoqiv3G8TLf4ajfpnON";
    ...
    public static void sendEmailValidateCode(String toEmail, String validateCode) {
        MailUtil.send(toEmail, "欢迎注册", validateCode, false);
    }
    ...
    public static void sendMessageCodeByAliyun(String randomCode, String mobile) {
        try {
            ...
            request.putQueryParameter("SignName", "Alpha02");
            request.putQueryParameter("TemplateCode", "SMS_180060566");
    ...
    public static void main(String[] args) {
        ...
        java.util.List<String> filesNameList = getDownloadFileList("D://uploadFiles");
        for (String s : filesNameList) {
            System.out.println(s);
        }
//        MyUtils.sendMessageCodeByAliyun("6379","17336401051");
    }
